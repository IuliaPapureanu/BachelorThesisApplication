...
<head>
    ...
    <style>
        ...
        body {
            ...
            color: #333333;
            max-width: 800px; /* Set the maximum width of the email */
            margin: 0 auto; /* Center the email horizontally */
        }
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
    <tr>
        <td align="center">
            <h1 class="m-5">MONTHLY REPORT</h1>
...
{{--                    THIS MONTH INFORMATION--}}
                    <div class="card m-2 p-1">
                        <div class="card-header p-1 text-white" style="background-color: rgba(75, 192, 192, 1);"> Monthly Profit</div>
                        <div class="card-body p-1">{{$lastProfit}}</div>
                    </div>
                    <div class="card m-2 p-1">
                        <div class="card-header p-1 text-white" style="background-color: rgb(100,192,75);"> Monthly Income</div>
                        <div class="card-body p-1">{{$lastIncome}}</div>
                    </div>
                    <div class="card m-2 p-1">
                        <div class="card-header p-1 text-white" style="background-color: rgb(192,75,93);"> Monthly Expenses</div>
                        <div class="card-body p-1">{{$lastExpenses}}</div>
                    </div>
                </div>
            </div>
            <div class="row my-4">

<x-layouts.backend>
    ...
    <h3 class="m-2">{{$company->name}} Balance Sheets</h3>
...
{{--            <th scope="col">Action</th>--}}
        ...
        @foreach($sheets as $sheet)
            ...
            <tr>
                ...
                <td>{{$sheet->month->name}}</td>
                <td>{{$sheet->year->number}}</td>
                <td>{{$sheet->profit}}</td>
                <td>{{$sheet->expenses}}</td>
                <td>{{$sheet->income}}</td>
                <td>
{{--                    <div class="dropdown">--}}
...
{{--                            <a class="dropdown-item" href="{{ route('companies.edit',$sheet->id) }}">--}}
...
{{--                                Edit--}}
{{--                            </a>--}}
{{--                            <a class="dropdown-item" href="{{ route('companies.show',$sheet->id) }}">--}}
{{--                                <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">--}}
{{--                                    <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->--}}
{{--                                    <path--}}
...
{{--                                <form action="{{ route('companies.destroy',$sheet->id) }}" method="POST">--}}
{{--                                    @csrf--}}
{{--                                    @method('DELETE')--}}
